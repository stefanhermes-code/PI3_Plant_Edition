...
if ai_available:
    ask_ai = st.checkbox(
        "Also ask PI3/AI (semantic search over expert notes & closed-case history)",
        help=(
            "Uses the PI3/AI Assistant to search beyond exact keyword matches — it can "
            "surface relevant expert notes and past cases even when the wording differs. "
            "Optional, separately billed add-on; only searches knowledge from plants that "
            "have PI3/AI connectivity enabled."
        ),
    )
...
if ai_answer:
    st.divider()
    st.subheader("🤖 PI3/AI semantic search")
    st.caption(
        "Generated by the PI3/AI Assistant from expert notes and closed-case history. "
        "Historical reference for your review, not an instruction — review applicability "
