...
tab_create, tab_edit_delete, tab_import = st.tabs(["Create Trial", "Edit/Delete Trial", "CSV / Excel import"])
        ...
        with sub_create:
            if not page_usable:
                ...
                with st.form(f"add_sample_{managed_trial.id}"):
                    ...
                    sample_ts = combine_date_time("Sample extraction time", f"ct_sample_ts_{managed_trial.id}")
                ...
                if selected_sample:
                    ...
                    with st.form(f"edit_ct_sample_{selected_sample.id}"):
                        ...
                        e_sample_ts = combine_date_time(
                            "Sample extraction time", f"edit_ct_sample_ts_{selected_sample.id}",
